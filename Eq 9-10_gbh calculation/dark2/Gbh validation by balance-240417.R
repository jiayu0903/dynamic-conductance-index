...
sspl_R <- smooth.spline(dE$time, dE$Humidity, df=26)
sspl_AW <- smooth.spline(dE2$time, dE2$Tair.wet, df=67)
sspl_RW <- smooth.spline(dE2$time, dE2$RH.wet, df=98)
