...
sspl_A <- smooth.spline(dE$time, dE$Temperature, df=12)
sspl_R <- smooth.spline(dE$time, dE$Humidity, df=25)
sspl_AW <- smooth.spline(dE2$time, dE2$Tair.wet, df=134)
sspl_RW <- smooth.spline(dE2$time, dE2$RH.wet, df=130)
